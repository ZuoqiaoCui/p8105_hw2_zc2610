...
Description 1. There are these variables: line, station_name,
station_latitude, station_longitude, route1, route2, route3, route4,
route5, route6, route7, route8, route9, route10, route11, entry,
exit_only, vending, entrance_type, ada 2. The process of tidying data is
to import, update variable names, and selects the columns that will be
used in later parts fo this problem. Then, I update `entry` from `yes` /
`no` to a logical variable. 3.There are totally 1868 rows and 20
columns. 4. I think it is not tidy enough since there are several
columns regarding route and they can be combined to a column “route”
with different numbers as values
...
Description There are totally 547 observations and 15 variables in the
Mr Trash Wheel dataset. There are totally 94 observations and 14
variables in the Professor Trash Wheel dataset. There are totally 641
...
190.12 The total number of sports balls collected by Mr. Trash Wheel in
2020 is 856
